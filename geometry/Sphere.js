...
class Sphere extends Object3D {
    ...
    subDivide(seed1, seed2, seed3, subDiv){
        ...
        if(subDiv > 0) {
            ...
            let mp1x = (seed1[0] + seed2[0]) / 2;
            let mp1y = (seed1[1] + seed2[1]) / 2;
            let mp1z = (seed1[2] + seed2[2]) / 2;


            let mp1 = vec3.fromValues(mp1x, mp1y, mp1z);
            ...
            let mp2x = (seed2[0] + seed3[0]) / 2;
            let mp2y = (seed2[1] + seed3[1]) / 2;
            let mp2z = (seed2[2] + seed3[2]) / 2;


            let mp2 = vec3.fromValues(mp2x, mp2y, mp2z);
            ...
            let mp3x = (seed1[0] + seed3[0]) / 2;
            let mp3y = (seed1[1] + seed3[1]) / 2;
            let mp3z = (seed1[2] + seed3[2]) / 2;


            let mp3 = vec3.fromValues(mp3x, mp3y, mp3z);
